...
<div class="checkout max-h-full bg-white rounded-2xl md:items-center md:mx-20 mt-14 mb-14">
  <div class="panel max-h-full flex flex-col rounded-2xl rounded-md md:flex-row mb-8 ">
    <div class="panel-left w-full md:w-2/3 rounded-l">
      <div class="max-w-sm mx-auto px-4 py-8">
              ...
              <div class="mt-6">
                <div class="mb-4">
                  <button id="card-button" data-secret="{{$intent->client_secret}}" type="submit"
                          class="text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200  font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Pay ${{number_format($plan->price / 100,2)}}</button>
                </div>
        ...
        @if(auth()->user()->subscribed('default'))
          <div>
            <h2 class="mb-12 text-center text-3xl font-bold text-gray-900">Update Plan</h2>
          </div>
