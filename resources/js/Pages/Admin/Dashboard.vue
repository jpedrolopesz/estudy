<template>
  <AdminLayout>
    ...
    <section class="grid mx-8 my-8 md:grid-cols-2 xl:grid-cols-4 gap-6">
      ...
      <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
          <span class="block text-2xl font-bold">68.987,00</span>
      ...
      <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
          ...
          <span class="block text-gray-500">Underperforming</span>
        </div>
      </div>
      <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
          <span class="block text-2xl font-bold">89</span>
          <span class="block text-gray-500">Comments</span>
        </div>
      </div>
    </section>
