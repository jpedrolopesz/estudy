          ...
          <div class="grid gap-2">
                ...
                <ul>
                  <li class="bg-white shadow-lg rounded-sm border border-slate-200 mb-2 p-2"
                      v-for="module in course.modules" :key="module.id">
                    <div class="flex">
                      <h4 class="font-semibold text-gray-800">{{module.id}}-</h4>
                      <input type="text" v-model="module.title" class="ml-2 font-semibold text-gray-800"/>
                    </div>
...
export default {
  components: {AuthenticatedUserLayout},
  props: {
    course:Object
  },
  data() {
