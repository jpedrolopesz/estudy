<template>
  ...
  <div id="course-sidebar"
       class="flex bg-white shadow-md  rounded-md sm:mx-2 border border-gray-200 flex-col absolute right-20 w-full sm:w-auto  md:static  md:bottom-auto md:translate-x-0 transform transition-transform duration-200 ease-in-out"
