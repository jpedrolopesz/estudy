          ...
          <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div v-for="course in courses" :key="course.id"
                ...
                <div class="relative rounded-md px-3 py-10 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                 {{course.title}}
                </div>
                <Link :href="route('showCourse', course.id)"
                      class="relative px-3 text-white text-sm font-semibold bg-gray-500">
                  Acessar
                </Link>
              </div>
